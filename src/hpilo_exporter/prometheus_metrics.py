...
hpilo_temperature_status_gauge  = Gauge('hpilo_temperature_status', 'HP iLO temperature status', ["product_name", "server_name", "sensor"])
...
gauges = {
    ...
    'hpilo_temperature_status_gauge' : hpilo_temperature_status_gauge
}
